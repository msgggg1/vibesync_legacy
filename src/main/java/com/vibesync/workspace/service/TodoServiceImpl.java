...
public class TodoServiceImpl implements TodoService {
    ...
    @Override
    @Transactional
    public void updateTodoStatus(int todoIdx, int status) {
        log.info("할 일 상태 업데이트. 할 일 ID: " + todoIdx + ", 상태: " + status);
        
        todoMapper.updateTodoStatus(todoIdx, status);
    }

				...
				<div id="loginView"
					...
					<div id="loginFormContainer" style="display: flex;">
						...
						<form action="${pageContext.request.contextPath}/login" 
							...
							<%-- 로그인 에러 메시지 --%>
							<c:if
								test="${ param.error != null or loginErrorForDisplay != null && !loginErrorForDisplay.isEmpty() }">
					...
					<div id="googleExtraInfoContainer"
						...
						<form
							action="${pageContext.request.contextPath}/member/complete-google-signup"
					...
					<div id="resetPasswordContainer" style="display: none;">
						<form action="${pageContext.request.contextPath}/member/request-password-reset"
